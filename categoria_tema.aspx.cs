...
public partial class tema : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            if (Session["tipo_tema"] != null)
            {
                ...
                if (Session["busca"] != null)
                {
                    ...
                    if (dadosDesc.Tables[0].Rows.Count > 0)
                    {
                        ...
                        DataSet dados = ws.ConsultaTemaTela(vTipoCategoria, busca);
            ...
            else
            {
                ...
                if (Session["busca"] == null)
                {
                    ...
                    int pos = ncategoria.IndexOf("Tema/");
                    ncategoria = ncategoria.Substring(pos + 5, ncategoria.Length - pos - 5);
                    ...
                    Session["tipo_tema"] = dadosDesc.Tables[0].Rows[0]["codigo"].ToString();
                }
    ...
    protected void dlAnunciante_ItemDataBound(object sender, DataListItemEventArgs e)
    {
        ...
        if (Convert.ToString(DataBinder.Eval(dbr, "foto")) != "")
        {
            ...
            string foto = Page.ResolveUrl("~/temas/" + Convert.ToString(DataBinder.Eval(dbr, "foto")));
    ...
    {
        vTipoCategoria = Convert.ToInt32(Session["tipo_tema"].ToString());
        DataSet dados = ws.ConsultaTemaTela(vTipoCategoria, "0");
        DataTable table = dados.Tables["tema"];
