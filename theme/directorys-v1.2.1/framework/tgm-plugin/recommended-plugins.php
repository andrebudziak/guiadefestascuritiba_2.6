...
function holo_register_required_plugins() {
    ...
    $config = array(
        ...
        'strings'      		=> array(
            ...
            'notice_ask_to_update' 						=> _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s. <br /> Please deactivate and delete the required plugins in order to start installing the new ones.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s.<br /> Please deactivate and delete the required plugins in order to start installing the new ones.' ), // %1$s = plugin name(s)
