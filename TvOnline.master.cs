...
public partial class TvOnline : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //{
                ...
                GerMenuSup(dlAlimentacao, "3");
                GerMenuSup(dlDiversao, "4");
                GerMenuSup(dlServicos, "5");
                GerMenuSup(dlTipoFesta, "6");
                Session["menu"] = "1";
