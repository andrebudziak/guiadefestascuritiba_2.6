...
public partial class Oferta : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //if (Session["menu"] == "0")
            //{
                GerMenuSup(dlLocais, "1");
                GerMenuSup(dlDecoracao, "2");
                GerMenuSup(dlAlimentacao, "1");
                GerMenuSup(dlDiversao, "2");
                GerMenuSup(dlServicos, "1");
                GerMenuSup(dlTipoFesta, "2");
                Session["menu"] = "1";
            ...
            if (Session["tipo_categoria"] != null)
            {
                ...
                dados = ws.descricaoCategoria(ncategoria);
    ...
    protected void lnk_lnkCategoria_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("~/Oferta/" + lnkCategoria.Text);
    }
    ...
    private void recarregaLayout()
    {
        ...
        btnClubOfertas.ImageUrl = Page.ResolveUrl("~/imagens/club_ofertas.png");
        btnVitrineTema.ImageUrl = Page.ResolveUrl("~/imagens/vitrine_tema.png");
        btnVitrineConvite.ImageUrl = Page.ResolveUrl("~/imagens/vitrine_convite.png");
